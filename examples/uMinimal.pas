...
const
  cDisplayTitle = 'Vivace: Minimal Demo';

type

  { TMinimalDemo }
  TMinimalDemo = class(TViGame)
  protected
...
{ --- TMinimalDemo ---------------------------------------------------------- }
procedure TMinimalDemo.OnLoad;
begin
  // mount archive file
  ViEngine.Mount(cArchiveFilename);
end;

procedure TMinimalDemo.OnExit;
begin
  // unmount archive file
  ViEngine.Unmount(cArchiveFilename);
end;

procedure TMinimalDemo.OnStartup;
begin
  // open display
...
procedure TMinimalDemo.OnShutdown;
begin
  // free console font
...
procedure TMinimalDemo.OnUpdate(aTimer: TViTimer; aDeltaTime: Double);
begin
  // process input
...
procedure TMinimalDemo.OnClearDisplay;
begin
  // clear display
  ViEngine.Display.Clear(BLACK);
end;

procedure TMinimalDemo.OnShowDisplay;
begin
  // show display
  ViEngine.Display.Show;
end;

procedure TMinimalDemo.OnRender;
begin
end;

procedure TMinimalDemo.OnRenderGUI;
var
  Pos: TViVector;
begin
